...
\\
\textbf{Theorem:} A graph is unique path graph if and only if in there are no cross/forward edges and atmost one backedge in every subtree of the dfs tree of vertex V'.\\
\textbf{Proof:}  
